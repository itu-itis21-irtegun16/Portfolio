let info = {
  ...
  links: {
    ...
    resume:
      "https://github.com/kaanirtegun8/git-fundamentals-draft-itu-itis21-irtegun16/blob/main/CV.pdf",
  },
  education: [
    {
  ...
  skills: [
    {
      title: "Language",
      info: ["Python", "Javascript", "TypeScript", "Java", "C#", "C/C++"],
      icon: "fa fa-code",
    },
    {
      title: "Front-end",
  ...
  portfolio: [
    {
      ...
      description:
        "Iron Monkey allows people to create a membership, create their own training program and add it to their personal calendar. You can also share your favorite words with other people and create a cooking program.",
    },
    {
      name: "Movie App",
      pictures: [
    ...
    },
    {
      ...
      category: "Web App",
      date: "December, 2022",
      github: "https://github.com/kaanirtegun8/React-Redux-Http-Example",
      visit: "https://vue-resource-6040f.web.app/",
      description: "It's a simple app I designed while learning react-redux.",
    },
    {
      ...
      category: "Web App",
      date: "December, 2022",
      github: "https://github.com/kaanirtegun8/weather-app",
      visit: "https://weather-app-4ada1.web.app/",
      description: "It's a simple weather app I designed while learning react.",
    },
    {
      name: "Case Study",
      pictures: [
      ...
      github: "https://github.com/itu-itis21-irtegun16/case-stduy-live",
      visit: "https://case-study-form.netlify.app/",
      description: " A simple case application. ",
    },
  ],
};
